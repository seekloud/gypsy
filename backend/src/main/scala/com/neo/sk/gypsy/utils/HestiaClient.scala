...
//  private val hestiaBaseUrl = hestiaProtocol + "://" + hestiaHost + ":" + hestiaPort
  ...
  private val appId = AppSettings.hestiaAppId
  private val secureKey = AppSettings.hestiaSecureKey
  private val hestiaImgPrefix = AppSettings.hestiaProtocol + "://" + AppSettings.hestiaAddress + s"/hestia/files/image/$appId/"
