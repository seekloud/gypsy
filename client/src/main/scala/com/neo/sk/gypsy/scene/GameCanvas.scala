...
class GameCanvas(canvas: Canvas,
                 ctx:GraphicsContext,
                 size:Point) {
  val  img = new Image("virus.png")
  val  circle = new Image("circle.png")
  val  circle1 = new Image("circle1.png")
  val  circle2 = new Image("circle2.png")
  val  circle3 = new Image("circle3.png")
  val  circle4 = new Image("circle4.png")
  val  circle5 = new Image("circle5.png")
  val  circle6 = new Image("circle6.png")
  val  kill = new Image("kill.png")
  val  youkill = new Image("youkill.png")
  val  shutdown = new Image("shutdown.png")
  val  killingspree = new Image("killingspree.png")
  val  dominating = new Image("dominating.png")
  val  unstoppable = new Image("unstoppable.png")
  val  godlike = new Image("godlike.png")
  val  legendary = new Image("legendary.png")
  val  background = new Image("background.png")
  val  background1 = new Image("background1.png")
  val  massImg = new Image("mass.png")
  private val goldImg =new Image("gold.png")
  private val silverImg = new Image("silver.png")
  private val bronzeImg = new Image("cooper.png")
