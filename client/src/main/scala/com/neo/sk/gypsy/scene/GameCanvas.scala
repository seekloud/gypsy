...
class GameCanvas(canvas: Canvas,
                 ctx:GraphicsContext,
                 size:Point) {
  val  img = new Image(ClientBoot.getClass.getResource("/img/virus.png").toString)
  val  circle = new Image(ClientBoot.getClass.getResource("/img/circle.png").toString)
  val  circle1 = new Image(ClientBoot.getClass.getResource("/img/circle1.png").toString)
  val  circle2 = new Image(ClientBoot.getClass.getResource("/img/circle2.png").toString)
  val  circle3 = new Image(ClientBoot.getClass.getResource("/img/circle3.png").toString)
  val  circle4 = new Image(ClientBoot.getClass.getResource("/img/circle4.png").toString)
  val  circle5 = new Image(ClientBoot.getClass.getResource("/img/circle5.png").toString)
  val  circle6 = new Image(ClientBoot.getClass.getResource("/img/circle6.png").toString)
  val  star1 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-01.png").toString)
  val  star2 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-02.png").toString)
  val  star3 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-03.png").toString)
  val  star4 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-04.png").toString)
  val  star5 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-05.png").toString)
  val  star6 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-06.png").toString)
  val  star7 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-07.png").toString)
  val  star8 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-08.png").toString)
  val  star9 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-09.png").toString)
  val  star10 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-10.png").toString)
  val  star11 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-11.png").toString)
  val  star12 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-12.png").toString)
  val  star13 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-13.png").toString)
  val  star14 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-14.png").toString)
  val  star15 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-15.png").toString)
  val  star16 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-16.png").toString)
  val  star17 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-17.png").toString)
  val  star18 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-18.png").toString)
  val  star19 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-19.png").toString)
  val  star20 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-20.png").toString)
  val  star21 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-21.png").toString)
  val  star22 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-22.png").toString)
  val  star23 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-23.png").toString)
  val  star24 = new Image(ClientBoot.getClass.getResource("/img/yuzhouxingqiu-24.png").toString)

  val  kill = new Image(ClientBoot.getClass.getResource("/img/kill.png").toString)
  val  youkill = new Image(ClientBoot.getClass.getResource("/img/youkill.png").toString)
  val  shutdown = new Image(ClientBoot.getClass.getResource("/img/shutdown.png").toString)
  val  killingspree = new Image(ClientBoot.getClass.getResource("/img/killingspree.png").toString)
  val  dominating = new Image(ClientBoot.getClass.getResource("/img/dominating.png").toString)
  val  unstoppable = new Image(ClientBoot.getClass.getResource("/img/unstoppable.png").toString)
  val  godlike = new Image(ClientBoot.getClass.getResource("/img/godlike.png").toString)
  val  legendary = new Image(ClientBoot.getClass.getResource("/img/legendary.png").toString)
  val  background1 = new Image(ClientBoot.getClass.getResource("/img/b2.jpg").toString)
  val  massImg = new Image(ClientBoot.getClass.getResource("/img/mass.png").toString)
  val deadbg = new Image(ClientBoot.getClass.getResource("/img/deadbg.jpg").toString)
  private val  goldImg = new Image(ClientBoot.getClass.getResource("/img/gold.png").toString)
  private val  silverImg = new Image(ClientBoot.getClass.getResource("/img//silver.png").toString)
  private val bronzeImg = new Image(ClientBoot.getClass.getResource("/img/cooper.png").toString)
